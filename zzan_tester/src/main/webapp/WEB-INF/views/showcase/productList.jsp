...
<body>
    <div id="wrap">
        <jsp:include page="/WEB-INF/views/ind/header.jsp" /> <!-- 헤더 추가 -->
        ...
        <div id="btnArea">
            <button type="button" onclick="location.href='/showcase/register'" style="cursor: pointer;">상품 등록</button>
			<button type="button" class="home-btn" onclick="location.href='/'" style="cursor: pointer;">홈으로 돌아가기</button>
